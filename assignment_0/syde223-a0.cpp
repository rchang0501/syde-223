...
public:
    ...
    int setInt (int x){         //this function gives myIntValue a new value
        myIntValue = x;
    }
    ...
    double setDouble (double x){      //this function gives myDoubleValue a new value
        myDoubleValue = x;
    }
    ...
    bool setBool (bool x){        //this function gives myBoolValue a new value
        myBoolValue = x;
    }
